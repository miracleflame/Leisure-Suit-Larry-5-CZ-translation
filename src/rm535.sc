...
(instance rm535 of LLRoom
	(properties
		lookStr {SedÌö s n·dhernou Michelle Milken v exkluzivnÌ soukromÈ kabince v exkluzivnÌm pokoji Hermana Holleritha v exkluzivnÌ kav·rnÏ Hard Disk Cafe v exkluzivnÌm New Yorku a usilovnÏ se snaûÌö nezÌrat p¯es jejÌ pr˘svitnou halenku.}
		picture 535
	)
...
(instance mEyes of Prop
	(properties
		x 153
		y 65
		description {jejÌ oËi}
		sightAngle 90
		lookStr {JejÌ smyslnÈ oËi se ti vpalujÌ do duöe.}
		view 535
		loop 2
		priority 13
		signal $4010
...
(instance mMouth of Prop
	(properties
		x 153
		y 68
		description {jejÌ ˙sta}
		sightAngle 90
		lookStr {JejÌ rty jsou vlhkÈ a vyz˝vavÈ.}
		view 535
		loop 4
		priority 14
		signal $4010
...
(instance iceCream of View
	(properties
		...
		sightAngle 90
		lookStr {Milujeö zmrzlinu. Obzvl·öù zmrzlinu, kter· sedÌ tam, kde je TA zmrzlina!}
		view 535
		loop 6
		signal $4000
	)
...
(instance cherry of Prop
	(properties
		x 148
		y 101
		description {jejÌ t¯eönÏ}
		sightAngle 90
		lookStr {JejÌ t¯eönÏ vypadajÌ jemnÏ, ËervenÏ, jsou zralÈ a p¯ipravenÈ k utrûenÌ!}
		view 535
		loop 9
		cel 1
		priority 14
