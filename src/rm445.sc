...
(instance theDataMan of View
	(properties
		...
		approachX 82
		approachY 99
		lookStr {Na pultu leí malé elektronické zobrazovací zaøízení.}
		view 440
		priority 6
		signal $0010
	)
...
(instance contraption of Feature
	(properties
		...
		sightAngle 40
		lookStr {Tady technik vyrobil prášek na nadımání. Na(ne)štìstí zanechal své vybavení dùkladnì èisté.}
	)
...
(instance desk of Feature
	(properties
		...
		description {stùl}
		sightAngle 40
		lookStr {Tento stùl neobsahuje ádné tajné dokumenty; všechny shoøely pøi velkém poáru minulı tıden!}
	)
