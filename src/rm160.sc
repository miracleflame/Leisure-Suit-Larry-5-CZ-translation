...
(instance rm160 of LLRoom
	(properties
		lookStr {Kdysi se PornProdCorp v˝raznÏ podÌlela na tvorbÏ film˘ pro dospÏlÈ, ale od svÈho ned·vnÈho vstupu na burzu, a rovnÏû vstupu do televizÌ s volnÏ p¯Ìstupn˝m programem, spoleËnost zcela zmÏnila svou image. NynÌ se snaûÌ prorazit si cestu k seriÛznosti.}
		picture 160
		north 180
		east 190
		west 170
...
(instance bigSign of Feature
	(properties
		...
		sightAngle 40
		lookStr {Tato spoleËnost je evidentnÏ autorem "NejvÌc sexy dom·cÌch videÌ Ameriky". O tomhle po¯adu jsi slyöel! Zvl·öù, kdyû tu pracujeö!}
	)
...
(instance pictures of Feature
	(properties
		...
		approachX 122
		approachY 75
		lookStr {Na fotografiÌch jsou b˝valÈ hvÏzdy mnoha film˘, televiznÌch po¯ad˘ a umÏleck˝ch dokument˘ spoleËnosti PornProdCorp. Je tu celkem nula fotek hlavnÌch p¯evÌjeË˘ videokazet, jako jsi ty. Nem·ö jedin˝ d˘vod p¯edpokl·dat, ûe budeö prvnÌ!}
	)
...
(instance onePicture of Feature
	(properties
		...
		approachX 231
		approachY 78
		lookStr {Je to buÔ hvÏzda filmu »erven˝ drak, nebo poû·rnÌ hydrant, nevÌö, co z toho.}
	)
...
(instance plant of Feature
	(properties
		...
		approachX 291
		approachY 75
		lookStr {Ten vzhled jemnÈho plastu se ti opravdu lÌbÌ.}
	)
...
(instance largePlant of Feature
	(properties
		...
		approachX 260
		approachY 179
		lookStr {PlastovÈ rostliny opravdu milujeö! (HlavnÏ tu v˘ni!)}
	)
...
(instance chair of Feature
	(properties
		...
		description {ûidle}
		sightAngle 40
		lookStr {Tato ûidle a st˘l pat¯Ì osobÏ, kter· je nejmÈnÏ oblÌben· u tvÈho öÈfa, Silase Scruemalla. V souËasnÈ dobÏ nenÌ obsazen·. »asto tady sedÌö ty.}
	)
...
(instance cabinetDoors of Feature
	(properties
		...
		description {sk¯ÌÚka}
		sightAngle 40
		lookStr {Ve sk¯ÌÚce pod konvicÌ na k·vu je jen krabice s promyölenÏ p¯edem odmÏ¯en˝mi, p¯edem zeslaben˝mi porcemi k·vy a nÏkolik pr·zdn˝ch plastov˝ch s·Ëk˘, ve kter˝ch b˝valy z·soby polystyrenov˝ch kelÌmk˘ na k·vu. Nepot¯ebujeö ani k·vu, ani filtry.}
	)
