...
(instance rm170 of LLRoom
	(properties
		lookStr {Na tu svou skromnou dÌlnu jsi ohromnÏ pyön˝.}
		picture 170
		east 160
	)
...
(instance sterileBarrel of Feature
	(properties
		...
		sightAngle 40
		lookStr {Tento barel obsahuje sterilizaËnÌ roztok, kter˝ pouûÌv·ö na vöechny p¯ÌchozÌ videokazety p¯ed jejich p¯evinutÌm a distribuov·nÌm Ëlen˘m konkurznÌho t˝mu ASHV.}
	)
...
(instance eightTrack of Prop
	(properties
		...
		sightAngle 40
		lookStr {Na tvÈm pracovnÌm stole leûÌ tv˘j vÏrn˝ osmistop˝ magnetofon Strombug Carlton. AËkoliv m·ö v poslednÌ dobÏ problÈmy se sh·nÏnÌm nov˝ch kazet, po¯·d ti to hezky hraje.}
		view 170
		cel 2
	)
