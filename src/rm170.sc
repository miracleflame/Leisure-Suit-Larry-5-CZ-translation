...
(instance rm170 of LLRoom
	(properties
		lookStr {Na tuhle svou skromnou dÌlnu jsi ohromnÏ pyön˝.}
		picture 170
		east 160
	)
...
(instance camcorderTapes of View
	(properties
		...
		approachX 236
		approachY 184
		lookStr {Naöel jsi je! Tohle jsou p·sky, kterÈ pot¯ebujeö do svÈ novÈ videokamery al· kapesnÌ pouzdro.}
		view 170
		priority 15
		signal $4010
	)
...
(instance door of Door
	(properties
		...
		approachX 240
		approachY 117
		lookStr {Dve¯e do haly ti p¯ipadajÌ tak zn·mÈ. NejspÌö proto, ûe jsi tudy vstoupil do tÈto mÌstnosti! Na zadnÌ stranÏ dve¯Ì visÌ tv˘j kalend·¯ "Videotechnikova dÏvËata", otev¯en˝ na stranÏ Miss ¯Ìjen, kter· m· (podle tvÈho n·zoru) nejlepöÌ "kotouËe" z celÈ party!}
		view 171
		loop 3
		entranceTo 160
		moveToX 285
...
(instance degausser of Feature
	(properties
		...
		sightAngle 40
		lookStr {Tv˘j demagnetizÈr, kter˝ pouûÌv·ö na p¯emaz·v·nÌ kazet, leûÌ na pracovnÌm stole.}
	)
...
(instance cabinet of Feature
	(properties
		...
		description {sk¯ÌÚka}
		sightAngle 40
		lookStr {Nem·ö ponÏtÌ, co je uvnit¯ tÏch sk¯ÌnÌ, protoûe jsi moc mal˝ na to, abys vidÏl dovnit¯.}
	)
...
(instance sterileBarrel of Feature
	(properties
		...
		sightAngle 40
		lookStr {Tento barel obsahuje sterilizaËnÌ roztok, kter˝ pouûÌv·ö na vöechny p¯ÌchozÌ videokazety p¯ed jejich p¯evinutÌm a distribuov·nÌm Ëlen˘m konkurznÌho t˝mu NejvÌc sexy dom·cÌ videa Ameriky.}
	)
...
(instance videotapes1 of Feature
	(properties
		...
		nsBottom 189
		nsRight 21
		description {nÏjakÈ videokazety}
		sightAngle 40
	)
...
(instance eightTrack of Prop
	(properties
		...
		sightAngle 40
		lookStr {Na tvÈm pracovnÌm stole leûÌ tv˘j vÏrn˝ osmistop˝ magnetofon Strombug Carlton. AËkoliv m·ö v poslednÌ dobÏ problÈmy se sh·nÏnÌm nov˝ch kazet, po¯·d ten magnetofon hezky hraje.}
		view 170
		cel 2
	)
		...
		(switch theVerb
			(3
				...
				(if (not local1)
					(= temp0
						(proc940_0
							{Jakou osmistopou kazetu chceö p¯ehr·t?}
							106
							81
							{___Larryho pÌseÚ___}
							100
							...
							501
							81
							{___UdÏlej to tvrdÏ___}
							502
							106
							81
							{__Michellina pÌseÚ__}
							535
							81
							{_____Shill-enstvÌ_____}
							620
							106
							81
							{______Sex a s·go______}
							345
							81
							{___Na prken·dÏ___}
							700
					...
					(= temp0
						(proc940_0
							...
							106
							81
							{____Zlobiv˝ holky_____}
							738
							81
							{_Kdo je teÔ naho¯e?_}
							740
							106
							81
							{__Trampovo kasino__}
