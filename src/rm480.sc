...
(instance sCartoon of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(23
				(localproc_0a0f {Manažer výtvarného týmu\n\nCheryl Loyd} 3)
				(= seconds 3)
			)
			(24
				(global2 drawPic: 1 13)
			...
			(29
				(localproc_0a0f {Dodateèná hudba\n\nChris Braymen} 3)
				(= seconds 3)
			)
			(30
				(localproc_0a0f
					{Dodateèný písemný materiál\n\nJosh Mandel}
					3
				)
				(= seconds 3)
			)
			(31
				(localproc_0a0f
					{Vedoucí týmu pro zajištìní kvality\n\nRobin Bradley}
					3
				)
				(= seconds 3)
			)
