...
(instance rm510 of LLRoom
	(properties
		lookStr {V hale kavárny "Hard Disk Café" je k vidìní nesmírnì vzrušující (pro nerdy) vıstava starıch poèítaèovıch pamìtihodností. Pøi pouhém pohledu na tohle místo se ti zrychlí tep.}
		picture 510
		north 525
		south 500
	)
...
(instance podium of Feature
	(properties
		...
		sightAngle 40
		onMeCheck $0002
		lookStr {Pult vrchního je akorát tak velkı, aby se za nìj mohl schovat, kdy po nìm dav zaène házet vìci!}
	)
)
