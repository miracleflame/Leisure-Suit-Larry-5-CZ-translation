...
(instance palmTrees of Feature
	(properties
		...
		description {palmy}
		sightAngle 40
		lookStr {Miami je plné exotických palem, jako jsou tyto.}
	)
)
...
(instance sidewalk of Feature
	(properties
		...
		description {chodník}
		sightAngle 40
		lookStr {Pozornì si chodník prohlížíš a docházíš k závìru, že doktor Vytlhal do plombování dìr na chodníku moc neinvestuje!}
	)
)
...
(instance window1 of Feature
	(properties
		...
		approachX 167
		approachY 115
		lookStr {Do tìch oken není potøeba nahlížet!}
	)
)
...
(instance tooth of Prop
	(properties
		...
		lookStr {Jeïte po dálnici Ventura na dálnici Fontainebleau, sjeïte na Eisenhowerovu silnici, a pak to øíznìte na výpadovku Slaussen. Vypadnìte z auta a zaøíznìte si trenky. Vrate se do auta a pokraèujte dál, dokud nedojedete na dálnici Beach Front. Po dálnici Beach Front jeïte na 22. jihozápadní ulici a zastavte, až pøijedete k obøímu otáèecímu zubu! Jste na místì! Nebeská dentální hygiena doktora Vytlhala!}
		view 900
		loop 2
		signal $6810
	)
