...
(instance sidewalk of Feature
	(properties
		...
		description {chodník}
		sightAngle 40
		lookStr {Pozornì si chodník prohlížíš a docházíš k závìru, že doktor Pulliam tady moc neutrácí za plombování kazù!}
	)
)
...
(instance window1 of Feature
	(properties
		...
		approachX 167
		approachY 115
		lookStr {Není tøeba nahlížet do tìch oken!}
	)
)
...
(instance tooth of Prop
	(properties
		...
		lookStr {Jdìte po dálnici Ventura na dálnici Fontainebleau a ze silnici Eisenhower na výpadovku Slaussen. Vystupte z auta a uøíznìte si šlajsnu. Vrate se do auta a pokraèujte dál, dokud nedojedete na dálnici Beach Front. Po dálnici Beach Front jeïte na 22. ulici Southwest a zastavte, až pøijedete k obøímu otáèecímu zubu! Jste na místì! Ráj dentální hygieny doktora Pulliama!}
		view 900
		loop 2
		signal $6810
	)
