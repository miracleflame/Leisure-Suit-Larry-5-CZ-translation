...
(instance rm760 of LLRoom
	(properties
		lookStr {Komercializace Trampovy krásné prkenády se zdá být dokonèena. Podniky lemují každý centimetr vzdálené strany prkenády. Alespoò ta bližší strana zùstala otevøená pro rybáøe a bruslaøe.}
		picture 760
		north 790
		east 760
		south 780
...
(instance skater6 of Skater
	(properties
		...
		lookStr {Na tuhle prkenádu je až moc obleèený!}
		view 776
		xStep 6
		room 2
		freq 2
...
(instance skater8 of Skater
	(properties
		y 110
		description {bruslaø}
		lookStr {Nemìl jsi tušení, že na prkenádì bude tolik bruslaøù!}
		view 778
		xStep 6
		room 2
		freq 2
...
(instance skater9 of Skater
	(properties
		y 91
		description {bruslaø}
		lookStr {Bruslaø, který se nikdy nevzdálí od obchodù na druhé stranì prkenády, najde opravdové štìstí, když své srdíèko rozbruslí!}
		view 779
		xStep 6
		room 2
		freq 2
...
(instance buildings of Feature
	(properties
		...
		sightAngle 40
		lookStr {Vzdálená strana Trampovy prkenády je lemována nevkusnými, lacinými turistickými pastmi. Skrz budovy vykukuje kousek modré oblohy.}
	)
...
(instance post1 of Feature
	(properties
		...
		description {sloup}
		sightAngle 40
		lookStr {Tyto sloupy drží prkenádu.}
	)
)
