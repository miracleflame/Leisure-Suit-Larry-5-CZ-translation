...
(instance mouthPic of Feature
	(properties
		...
		sightAngle 40
		lookStr {Pokud bys dodržoval pravidelný plán ústní hygieny s Chi Chi Lambada, tvé zuby by byly také šastné!}
	)
)
...
(instance drill of Feature
	(properties
		...
		description {vrtaèka}
		sightAngle 40
		lookStr {Kdykoli spatøíš vysokootáèkovou zubní vrtaèku, tiše si pøísaháš, že budeš èastìji používat zubní nit!}
	)
)
...
(instance sink of Feature
	(properties
		...
		sightAngle 40
		lookStr {Miluješ, když ti žena naøídí: "Plivej!" }
	)
)
...
(instance dentalTools of Feature
	(properties
		...
		nsBottom 141
		nsRight 169
		description {zásobník zubaøských nástrojù}
		sightAngle 40
...
(instance chair of Feature
	(properties
		...
		sightAngle 40
		lookStr {Ty prostì miluješ elektrický nábytek!}
	)
)
...
(instance degree of Feature
	(properties
		...
		sightAngle 40
		lookStr {Zajímavé. Netušil jsi, že Kolumbijská rozhlasová škola mìla dokonce i vysokou školu zubního lékaøství!}
	)
)
