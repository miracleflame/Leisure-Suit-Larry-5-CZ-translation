...
(instance mouthPic of Feature
	(properties
		...
		sightAngle 40
		lookStr {Pokud bys dodržoval pravidelný plán ústní hygieny s Chi Chi Lambadou, tvé zuby by byly také tak šastné!}
	)
)
...
(instance drill of Feature
	(properties
		...
		description {vrtaèka}
		sightAngle 40
		lookStr {Kdykoliv spatøíš vysokorychlostní zubní vrtaèku, tiše si pøísaháš, že budeš èastìji používat zubní nit!}
	)
)
...
(instance sink of Feature
	(properties
		...
		sightAngle 40
		lookStr {Miluješ, když ti žena pøikáže: "Plivej!"}
	)
)
...
(instance dentalTools of Feature
	(properties
		...
		nsBottom 141
		nsRight 169
		description {tác se zubaøskými nástroji}
		sightAngle 40
		lookStr {Vždycky jsi vìøil, že zubaøi mají skryté masochistické sklony.}
	)
)
...
(instance chair of Feature
	(properties
		...
		sightAngle 40
		lookStr {Ty prostì miluješ elektrifikovaný nábytek!}
	)
)
...
(instance degree of Feature
	(properties
		...
		sightAngle 40
		lookStr {Zajímavé. Netušil jsi, že Kolumbijská rozhlasová škola mìla dokonce i fakultu zubního lékaøství!}
	)
)
...
(instance light of Feature
	(properties
		...
		sightAngle 40
		lookStr {Rád se díváš na odraz svých úst na povrchu zubaøského reflektoru.}
	)
)
