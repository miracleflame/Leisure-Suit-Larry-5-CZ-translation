...
(instance elevator of Prop
	(properties
		...
		approachX 65
		approachY 152
		lookStr {Tímto výtahem jste pøijeli.}
		view 640
		priority 10
		signal $4011
		cycleSpeed 12
...
(instance plant of Feature
	(properties
		...
		sightAngle 40
		lookStr {Pøi bližším zkoumání zjistíte, že se jedná o rostlinu.}
	)
)
...
(instance recordJacketsB of Feature
	(properties
		...
		sightAngle 40
		lookStr {Mnoho slavných obalù od gramofonových desek zdobí stìny kanceláøe des Rever Records.}
	)
)
